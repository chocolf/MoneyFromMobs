...
public class FloatingTextArmorStandV1_16_R2 extends EntityArmorStand{
	
	public FloatingTextArmorStandV1_16_R2(Location loc, String messageToSend) {
		super(EntityTypes.ARMOR_STAND, ((CraftWorld) loc.getWorld()).getHandle() );
		
		FloatingTextArmorStandV1_16_R2 armorstand = this;
